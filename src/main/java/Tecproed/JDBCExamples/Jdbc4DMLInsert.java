...
//		System.out.println(s1 + " satir eklendi"); // buraya kadar ki eklemedir.
//		
		ResultSet rs = st.executeQuery("SELECT * FROM bolumler"); // tabloyu gosteriyoruz
...
// 	}
// 	System.out.println(s2 + " satir eklendi"); // 3 satir eklendi
